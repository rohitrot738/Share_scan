...
class PatternFeatures:
    impulse_pct: float; consolidation_range_pct: float; volume_dryup_ratio: float; breakout_distance_pct: float; higher_low_strength: float; trend_alignment: float; rvol_now: float; rsi14: float; macd_hist: float; vwap_gap_pct: float; bb_position: float; stoch_k: float; adx14: float; cci20: float; mfi14: float; obv_slope: float; roc12: float; supertrend_dir: float; ichimoku_bull: float; pivot_gap_pct: float; support_hold_strength: float; supply_exhaustion: float; base_quality: float; resistance: float; support: float
...
def extract_features(df,cfg):
    ...
    return PatternFeatures(impulse_pct,consolidation_range_pct,volume_dryup_ratio,breakout_distance_pct,higher_low_strength,trend_alignment,rvol_now,rsi14,macd_hist,vwap_gap_pct,bb_position,stoch_k,adx14,cci20,mfi14,obv_slope,roc12,supertrend_dir,ichimoku_bull,pivot_gap_pct,support_hold,supply,base,bh,bl)
